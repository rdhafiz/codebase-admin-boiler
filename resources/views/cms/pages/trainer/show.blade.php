                            ...
                            <div class="form-group mb-4">
                                @if(isset($trainer['avatar']) && !empty($trainer['avatar']))
                                    <div class="w-100 mb-2">
                                        <img class="img-fluid rounded-pill border border-2 mb-2" style="width: 200px; height: 200px; object-fit: cover;overflow: hidden;" src="{{$trainer['avatar_full_path']}}" alt="">
                                    </div>
                                @endif
                            </div>
                            <div class="form-group mb-4">
