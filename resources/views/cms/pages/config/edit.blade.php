    ...
    <div class="w-100 p-3 p-lg-5">
        ...
        <div class="container-lg">
            <div class="w-100 mb-4">
                <h2 class="fs-2 m-0 p-0">Edit Website Config</h2>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('CMS.dashboard')}}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{route('CMS.config.index')}}">Website Config</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Edit Website Config</li>
                    </ol>
                </nav>
            </div>
            ...
            @endif
            <form class="w-100" action="{{route('CMS.config.update', [$config['_id']])}}" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                <input type="hidden" name="_method" value="PUT">
                <div class="w-100 mt-4">
                    <div class="block block-rounded">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">Edit Website Config</h3>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="text" class="form-control" name="name" value="{{old('name') ?? $config['name']}}" placeholder="Config Name">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group mb-4">
                                            <label class="form-label">Config Name</label>
                                            <input type="text" class="form-control" name="value" value="{{old('value') ?? $config['value']}}" placeholder="Config Value">
