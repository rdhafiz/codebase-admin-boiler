...
@section('content')
    <div class="w-100 p-3 p-lg-5">
        ...
        <div class="container-lg">
            ...
            @endif
            <form class="w-100" action="{{route('CMS.course.schedule.update', [$schedule['_id']])}}" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="text" class="form-control js-flatpickr" name="end_date" value="{{old('end_date') ?? $schedule['end_date']}}" placeholder="Schedule End Date"
                                                   data-alt-input="true" data-date-format="Y-m-d" data-alt-format="F j, Y">
