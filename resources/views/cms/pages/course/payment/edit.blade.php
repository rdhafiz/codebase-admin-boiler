    ...
    <div class="w-100 p-3 p-lg-5">
        ...
        <div class="container-lg">
            <div class="w-100 mb-4">
                <h2 class="fs-2 m-0 p-0">Edit Course Plan</h2>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('CMS.dashboard')}}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{route('CMS.course.payment.index')}}">Course Plan</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Edit Course Plan</li>
                    </ol>
                </nav>
            </div>
                ...
                <div class="w-100 mt-4">
                    <div class="block block-rounded">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">Edit Course Plan</h3>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="text" class="form-control" name="name" value="{{old('name') ?? $product['name']}}" placeholder="Plan Name">
