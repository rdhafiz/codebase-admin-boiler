    ...
    <div class="w-100 p-3 p-lg-5">
        ...
        <div class="container-lg">
            <div class="w-100 mb-4">
                <h2 class="fs-2 m-0 p-0">New Course Payment</h2>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('CMS.dashboard')}}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{route('CMS.course.payment.index')}}">Course Payment</a></li>
                        <li class="breadcrumb-item active" aria-current="page">New Course Payment</li>
                    </ol>
                </nav>
            </div>
                ...
                <div class="w-100 mt-4">
                    <div class="block block-rounded">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">New Course Payment</h3>
