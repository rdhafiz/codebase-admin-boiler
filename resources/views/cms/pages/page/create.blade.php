    ...
    <div class="w-100 p-3 p-lg-5">
        ...
        <div class="container-lg">
            <div class="w-100 mb-4">
                <h2 class="fs-2 m-0 p-0">New Page</h2>
            ...
            @endif
            <form class="w-100" action="{{route('CMS.page.store')}}" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="w-100 mt-4">
                    <div class="block block-rounded">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">New Page</h3>
                            <div class="block-options">
                                <a href="{{route('CMS.page.index')}}" class="btn btn-sm btn-outline-secondary me-1">Cancel</a>
                                <button type="submit" class="btn btn-sm btn-outline-success">Save Page</button>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="text" class="form-control" name="meta[keyword]">
                                        </div>
                                        <div class="form-group mb-4">
                                            <label class="form-label">Page Description</label>
                                            <input type="text" class="form-control" name="meta[description]">
