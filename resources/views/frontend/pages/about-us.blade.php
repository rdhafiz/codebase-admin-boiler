    ...
    <div class="about_page">
        ...
        <div class="page_header" style="background-image: url({{asset('assets/images/frontend/resources/wave-1.svg')}})">
            <div class="container-lg">
                <h1 class="page_title" data-aos="fade-left" data-aos-delay="1000" data-aos-duration="1000">About Us</h1>
            </div>
        </div>
            ...
            <div class="container-lg">
                <div class="about_section_content" data-aos="fade-up" data-aos-duration="1000">
                    <div class="row align-items-center py-3 py-sm-4 py-lg-5 mb-3 my-sm-2 my-md-3 my-lg-0 my-xl-2 my-xxl-4" data-aos="fade-up" data-aos-duration="600" data-aos-offset="280" data-disable-parallax-down="md">
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-6 order-md-2" data-aos="fade-up" data-aos-duration="800" data-aos-offset="180" data-disable-parallax-down="md">
                            <div class="pe-md-4 pe-lg-0">
        ...
        <div class="about_section mb-5">
            <div class="container-lg">
                <div class="about_section_content bg-secondary p-5 rounded rounded-5" data-aos="fade-up" data-aos-duration="1000">
                    <div class="row align-items-center py-3 py-sm-4 py-lg-5 my-sm-2 my-md-3 my-lg-0 my-xl-2 my-xxl-4" data-aos="fade-up" data-aos-duration="600" data-aos-offset="280" data-disable-parallax-down="md">
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-6 order-md-1" data-aos="fade-up" data-aos-duration="800" data-aos-offset="180" data-disable-parallax-down="md">
                            <div class="pe-md-4 pe-lg-0">
