<div class="why-choose-us" style="background-color: #151F35">
{{--    <div class="section_title_ui">--}}
{{--        <div class="section_title" data-aos="flip-up" data-aos-duration="1000">Why Would You Choose Us?</div>--}}
{{--    </div>--}}
    <div class="w-100 d-inline-block ptt-5 mtt-5">
        <div class="w-100 d-inline-block p-lg-5 mt-5">
            <div class="w-100 px-lg-5">
                <div class="w-100 px-5">
                    <h1 class="text-white m-0" style="font-weight: lighter">Why Choose Us?</h1>
                    <h1 class="text-white m-0">We prioritise Your future</h1>
                </div>
            </div>
            <div class="w-100 pt-5">
                <div class="owl-carousel owl-theme" id="why-choose-slide">
...
<div class="why-choose-us extra-pad" style="background-image: url({{ asset('assets/images/frontend/home/about_us.jpg') }})">
    ...
    <div class="w-100 d-none d-xl-flex align-content-end justify-content-between">
        <div class="d-flex justify-content-start">
            <div class="each-choose-box" data-aos="zoom-in" data-aos-delay="500" data-aos-duration="1000" style="background-image: url({{asset('assets/images/shapes/choose-1.svg')}})">
                ...
                <div class="w-100 px-3">
                    <h2><strong>Practical Based</strong></h2>
            ...
            <div class="each-choose-box" data-aos="zoom-in" data-aos-delay="1000" style="background-image: url({{asset('assets/images/shapes/choose-2.svg')}})">
                <ul class="cube_rains">
                    <li></li>
                    <li></li>
                    <li></li>
                ...
                <div class="w-100 px-3">
                    <h2 class="text-white">Online Platform</h2>
    ...
    <div class="owl-carousel owl-theme d-xl-none" id="why-choose-item-slide">
        ...
        <div class="item">
            <div class="each-choose-box" data-aos="zoom-in" data-aos-delay="1000" style="background-image: url({{asset('assets/images/shapes/choose-2.svg')}})">
                ...
                <div class="w-100 px-3">
                    <h3 class="text-white">Online Platform</h3>
                    <p class="m-0 text-white">
                        Even after our training sessions are over, you'll still have access to
                        all our resources and guidelines through our online learning platform.
                        This way, you can keep learning and practicing until you take your exam.
