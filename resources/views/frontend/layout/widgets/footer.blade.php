        ...
        <div class="row pb-5 pt-sm-2 mb-lg-2">
            <div class="col-md-12">
                <div class="d-flex gap-3">
                    <a class="btn btn-icon btn-sm btn-primary btn-facebook rounded-circle" href="#" aria-label="Facebook">
                        <i class="ai-facebook"></i>
                    </a>
                    <a class="btn btn-icon btn-sm btn-primary btn-instagram rounded-circle" href="#" aria-label="Instagram">
                        <i class="ai-instagram"></i>
                    </a>
                    <a class="btn btn-icon btn-sm btn-primary btn-linkedin rounded-circle" href="#" aria-label="LinkedIn">
