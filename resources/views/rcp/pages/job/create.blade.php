    ...
    <div class="w-100 p-3 p-lg-5">
        ...
        <div class="container-lg">
            <div class="w-100 mb-4">
                <h2 class="fs-2 m-0 p-0">New Job</h2>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="text" class="form-control" name="company_website" value="{{old('company_website')}}" placeholder="Company Website">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group mb-4">
                                            ...
                                            <select name="job_type" class="form-select">
                                                <option {{old('job_type') == 'Full Time' ? 'selected' : ''}} value="Full Time">Full Time</option>
                                                <option {{old('job_type') == 'Part Time' ? 'selected' : ''}} value="Part Time">Part Time</option>
                                                <option {{old('job_type') == 'Internship' ? 'selected' : ''}} value="Internship">Internship</option>
                                                <option {{old('job_type') == 'Temporary' ? 'selected' : ''}} value="Temporary">Temporary</option>
                                                <option {{old('job_type') == 'Locum' ? 'selected' : ''}} value="Locum">Locum</option>
                                            </select>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control mb-2" name="salary_min" value="{{old('salary_min')}}" placeholder="Minimum Amount">
                                                    @if($errors->has('salary_min'))
                                                        <small class="text-danger">{{$errors->first('salary_min')}}</small>
                                                    @endif
                                                </div>
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" name="salary_max" value="{{old('salary_max')}}" placeholder="Maximum Amount">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group mb-4">
                                            ...
                                            <textarea id="js-ckeditor" name="job_description" class="form-control form-control-lg" cols="30" rows="5">{{ old('job_description') }}</textarea>
